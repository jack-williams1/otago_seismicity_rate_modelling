...
#load section area info (generated by get_section_area.py in nshm_inversion scripts)
sec_info=pd.read_csv('nshm_inversion/solvis/WORK/otago_section_area.csv',header=None)
sec_info_list=sec_info[0].tolist()

# load all fault section info from the NSHM inversion
flt_sections=gpd.read_file('nshm_inversion/CRU_fault_system_solution/ruptures/fault_sections.geojson')
